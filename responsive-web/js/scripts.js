$(document).ready(function () {
    ...
    // Vinculação do Produto com as imagens
    $("img#hotone").click(function () {
    ...
    $("img#offer").click(function () {
        $("div#product-offer").removeAttr("style")
        $("main-container").prepend("div#product-offer")
        $("product-offer").fadeIn("slow")
    });
    $("span#close").click(function () {
        $("div#product-offer").fadeOut("fast")
    })
